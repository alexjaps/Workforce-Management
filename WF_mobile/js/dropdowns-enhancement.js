...
(function($) {
    ...
    var toggle   = '[data-toggle="dropdownA"]',
        disabled = '.disabled, :disabled',
        backdrop = '.dropdownA-backdrop',
        menuClass = 'dropdownA-menu',
        subMenuClass = 'dropdownA-submenu',
        namespace = '.bs.dropdownA.data-api',
        eventNamespace = '.bs.dropdownA',
        openClass = 'open',
        touchSupport = 'ontouchstart' in document.documentElement,
        opened;


    function DropdownA(element) {
        $(element).on('click' + eventNamespace, this.toggle)
    }

    var proto = DropdownA.prototype;
    ...
    $.fn.dropdownA.clearMenus = function(e) {
        $(backdrop).remove();
    ...
    $(document).off(namespace)
        ...
        .on('click' + namespace, '.dropdownA-menu > li > input[type="checkbox"] ~ label, .dropdownA-menu > li > input[type="checkbox"], .dropdownA-menu.noclose > li', function (e) {
            e.stopPropagation()
        })
        .on('change' + namespace, '.dropdownA-menu > li > input[type="checkbox"], .dropdownA-menu > li > input[type="radio"]', proto.change)
        .on('keydown' + namespace, toggle + ', [role="menu"], [role="listbox"]', proto.keydown)
}(jQuery));



/* modified by Ariel Garcia */